    ...
    <div className="border p-4 m-2 shadow-lg hover:shadow-none rounded w-72 md:w-1/3 bg-myBrown-200">
      <Link to={myRoutes}>
        <div className="flex justify-between items-center">
          ...
          <p className="border p-2 rounded-full shadow">
            #
        ...
        <p className="text-center text-sm font-thin mt-2 mb-5 italic text-gray-500">
          - {state['catch-phrase']} -
        </p>
        <div className="flex justify-between">
          <p className=" flex justify-center px-3 py-1 bg-myPink-200 text-white text-sm font-medium rounded-full">
            {state.availability.location}
          </p>
          <p className=" flex justify-center px-3 py-1 bg-myBlue-200 text-myPink-200 text-sm font-medium rounded-full">
